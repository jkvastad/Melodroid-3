...
graph lcm-families      Mermaid relation graph (--mode full|collapsed; full mode labels each renormalized-subset edge with every base at which the smaller family embeds)
