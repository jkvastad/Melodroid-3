...
## Harmony as pattern recognition of simultaneous frequencies
...
### Assumptions
Given the lower frequency hearing threshold for humans of 20hz, a frequency pattern extending over more than 50ms will likely not be recognized/pattern matched.
* E.g. for a fundamental of 100hz the major chord with FPL 4 the frequency pattern duration (FPD) is 40ms.
...
* Lower frequencies produce longer duration patterns, thus 100hz can be used as a worst case for FPD.

Denominators of fractions in a set determine the FPL and music is octave equivalent - all fractions are mapped onto "[1,2)": 
